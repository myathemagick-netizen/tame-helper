...
local tomes = {
    ...
    },
    {
        ...
        defaultRaces = {},
        hint         = "Buy from Pan the Kind Hand after Legion hunter class mount questline",
    },
    {
        name         = "Cloud Serpents",
        spellID      = 340826,
...
function TameHelper:DisplayAvailablePets()
    ...
    for _, t in ipairs(tomes) do
        ...
        if ok and isDefault then
            -- Show which race perk gave it to them
            line = line .. "  " .. GREY .. "(" .. race .. " default)|r"
        elseif not ok then
            -- Show how to get it: hoverable item link if we have an itemID, else gold hint text
